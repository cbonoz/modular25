					...
					<Row gutter={[32, 32]}>
						<Col xs={24} md={8}>
							...
							>
								...
								<p style={{ color: '#6b7280', lineHeight: '1.6' }}>
									Smart contracts automatically validate reimbursements against your custom policy
									rules
								</p>
							</div>
						</Col>
						...
						<Col xs={24} md={8}>
							...
							>
								...
								>
									Smart Contract Supported Processing
								</h3>
								<p style={{ color: '#6b7280', lineHeight: '1.6' }}>
									Filecoin-backed proof enables reimbursement processing with contract events and
									notifications.
								</p>
							</div>
						</Col>
						...
						<Col xs={24} md={8}>
							...
							>
								...
								<p style={{ color: '#6b7280', lineHeight: '1.6' }}>
									Get started immediately without accounts or vendor agreements - just connect your
									wallet
								</p>
							</div>
						</Col>
